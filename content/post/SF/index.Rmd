...
Aqui os dados estão marcados como comentários com `#` porque já foi feito o dowload do dados, para rodar o código e decarregar os dados só retirar o `#`. Lembrando que no meu caso estou sanvando numa pasta denominda *shape*.
...
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_MASSAS_DAGUA.dbf",  destfile = "./shape/MG_3161106_MASSAS_DAGUA.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_MASSAS_DAGUA.prj", destfile = "./shape/MG_3161106_MASSAS_DAGUA.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_MASSAS_DAGUA.shp",  destfile = "./shape/MG_3161106_MASSAS_DAGUA.shp")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_MASSAS_DAGUA.shx", destfile = "./shape/MG_3161106_MASSAS_DAGUA.shx")

## Nascentes - São Francisco
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_NASCENTES.dbf", destfile = "./shape/MG_3161106_NASCENTES.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_NASCENTES.prj", destfile = "./shape/MG_3161106_NASCENTES.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_NASCENTES.shp", destfile = "./shape/MG_3161106_NASCENTES.shp")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_NASCENTES.shx", destfile = "./shape/MG_3161106_NASCENTES.shx")

## Rios Duplos - São Francisco
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_DUPLOS.dbf", destfile = "./shape/MG_3161106_RIOS_DUPLOS.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_DUPLOS.prj", destfile = "./shape/MG_3161106_RIOS_DUPLOS.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_DUPLOS.shp", destfile = "./shape/MG_3161106_RIOS_DUPLOS.shp")
# download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_DUPLOS.shx", destfile = "./shape/MG_3161106_RIOS_DUPLOS.shx")

## Rio simples - São Francisco
# download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_SIMPLES.dbf", destfile = "./shape/MG_3161106_RIOS_SIMPLES.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_SIMPLES.prj", destfile = "./shape/MG_3161106_RIOS_SIMPLES.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_SIMPLES.shp", destfile = "./shape/MG_3161106_RIOS_SIMPLES.shp")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/HIDROGRAFIA/MG_3161106_RIOS_SIMPLES.shx", destfile = "./shape/MG_3161106_RIOS_SIMPLES.shx")

## APP - São Francisco
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/APP/MG_3161106_APP.dbf",             destfile = "./shape/MG_3161106_APP.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/APP/MG_3161106_APP.prj",               destfile = "./shape/MG_3161106_APP.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/APP/MG_3161106_APP.shp",               destfile = "./shape/MG_3161106_APP.shp")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/APP/MG_3161106_APP.shx",               destfile = "./shape/MG_3161106_APP.shx")

## Uso do solo - São Francisco
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/USO/MG_3161106_USO.dbf",               destfile = "./shape/MG_3161106_USO.dbf")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/USO/MG_3161106_USO.prj",               destfile = "./shape/MG_3161106_USO.prj")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/USO/MG_3161106_USO.shp",              destfile = "./shape/MG_3161106_USO.shp")
#download.file(url = "http://geo.fbds.org.br//MG/SAO_FRANCISCO/USO/MG_3161106_USO.shx",               destfile = "./shape/MG_3161106_USO.shx")
```
...
## Massa de água
massa <- sf::st_read("./shape/MG_3161106_MASSAS_DAGUA.shp") # pode demorar
massa
plot(massa$geometry)
# Explorando o geobr::
...
# land use
uso <- sf::st_read("./shape/MG_3161106_USO.shp") # pode demorar
uso
plot(uso$geometry)
