...
plot(sp1, name='name', color='structure_grade',cex.names=0.5,cex.id=0.5, id.style='top',col.legend.cex=1,family="serif", col.label='Estrutura', )

sp1$prop # 
par(mar=c(1,1,3,1)) # tighter figure margins
plot(sp1, name='name', color='prop',cex.names=0.5,cex.id=0.5, id.style='top',col.legend.cex=1,
     col.label='Prop', family="serif")
