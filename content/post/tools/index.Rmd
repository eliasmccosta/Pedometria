...
# Parte III
Nessa parte é usado outra base de dados do `soilDB` são eles o conjunto `loafercreek` e o conjunto `mineralKing`, e aqui além de plots que marcam os horizontes diagnósticos de alguns perfis é feitos alguns plots que relacionam o perfil e a paisagem. Maiores comentários estam na linha de código
