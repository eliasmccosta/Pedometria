...
dados <- read.csv("/home/elias/Dropbox/WEB/Pedometria/static/data/dataset.csv"); dados=dados[2:54]
grid <- read.csv("/home/elias/Dropbox/WEB/Pedometria/static/data/grid.csv"); grid=grid[2:23]
...
## Estradas
estrada <- maptools::readShapeSpatial("/home/elias/Dropbox/WEB/Pedometria/static/shape/estrada.shp", 
                                         proj4string=crsSIRGAS2000,verbose=TRUE)
## Perfis completos
perfis <- maptools::readShapeSpatial("/home/elias/Dropbox/WEB/Pedometria/static/shape/pontos.shp", 
                                      proj4string=crsSIRGAS2000,verbose=TRUE)
```
